          ...
          <div className='flex flex-col gap-6'>
                ...
                <div className='flex flex-col gap-6'>
                  <div className='grid gap-2'>
                    <p className="text-sm text-muted-foreground">
                      We sent a code to
                      <span className=" italic font-bold"> <SignIn.SafeIdentifier />.</span>
                    </p>
                ...
                <div className='flex flex-col gap-6'>
                  <div className='grid gap-2'>
                    ...
                    <Clerk.Field name="password">
                      <div className='flex justify-between'><Clerk.Label>Password</Clerk.Label><SignIn.Action navigate="forgot-password">Forgot password?</SignIn.Action></div>
                      <Clerk.Input asChild>
                        <Input />
                      </Clerk.Input>
                      <Clerk.FieldError className="text-red-600 text-sm italic" />
            ...
            <SignIn.Step name="forgot-password">
              ...
              <div className='flex justify-between'>
                ...
                <SignIn.SupportedStrategy name="reset_password_email_code"><p className="text-sm text-muted-foreground underline">Reset password</p>

                </SignIn.SupportedStrategy>

                <div className='flex flex-row'><SignIn.Action navigate="previous"><ArrowLeft className="h-5 w-5"></ArrowLeft> Go back</SignIn.Action></div></div>
